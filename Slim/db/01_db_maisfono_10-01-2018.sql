...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 10-Jan-2019 às 12:56
...
--
-- Database: `db_maisfono`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `aux_cidade`
--

DROP TABLE IF EXISTS `aux_cidade`;
CREATE TABLE IF NOT EXISTS `aux_cidade` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `DSC_NOME` varchar(120) DEFAULT NULL,
  `FRG_UF` int(2) DEFAULT NULL,
  `CT_IBGE` int(7) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5611 DEFAULT CHARSET=utf8 COMMENT='Municipios das Unidades Federativas';

--
-- Extraindo dados da tabela `aux_cidade`
--

INSERT INTO `aux_cidade` (`ID`, `DSC_NOME`, `FRG_UF`, `CT_IBGE`) VALUES
...
INSERT INTO `aux_cor` (`id`, `dsc_cor`) VALUES
(1, 'Branco(a)'),
(2, 'Pardo(a)'),
(3, 'Preto(a)'),
(4, 'Amarelo(a)'),
...
--
-- Estrutura da tabela `aux_deficiencia`
--

DROP TABLE IF EXISTS `aux_deficiencia`;
CREATE TABLE IF NOT EXISTS `aux_deficiencia` (
  `id` int(11) NOT NULL,
  `dsc_nome` varchar(45) DEFAULT NULL,
  `dsc_descricao` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Estrutura da tabela `aux_dia_semana`
--

DROP TABLE IF EXISTS `aux_dia_semana`;
CREATE TABLE IF NOT EXISTS `aux_dia_semana` (
  `id` int(11) NOT NULL,
  `dsc_nome` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estrutura da tabela `aux_estado`
--

DROP TABLE IF EXISTS `aux_estado`;
CREATE TABLE IF NOT EXISTS `aux_estado` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `DSC_NOME` varchar(75) DEFAULT NULL,
  `DSC_UF` varchar(2) DEFAULT NULL,
  `UF_IBGE` int(2) DEFAULT NULL,
  `UF_SL` int(3) DEFAULT NULL,
  `DSC_DDD` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 COMMENT='Unidades Federativas';

--
-- Extraindo dados da tabela `aux_estado`
--

INSERT INTO `aux_estado` (`ID`, `DSC_NOME`, `DSC_UF`, `UF_IBGE`, `UF_SL`, `DSC_DDD`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
--
-- Estrutura da tabela `aux_estado_civil`
--

DROP TABLE IF EXISTS `aux_estado_civil`;
CREATE TABLE IF NOT EXISTS `aux_estado_civil` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dsc_estado_civil` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `aux_estado_civil`
--

INSERT INTO `aux_estado_civil` (`id`, `dsc_estado_civil`) VALUES
(1, 'Solteiro(a)'),
(2, 'Casado(a)'),
(3, 'Divorciado(a)'),
(4, 'Viúvo(a)'),
...
--
-- Estrutura da tabela `aux_fonema`
--

DROP TABLE IF EXISTS `aux_fonema`;
CREATE TABLE IF NOT EXISTS `aux_fonema` (
  `id` int(11) NOT NULL,
  `dsc_nome` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estrutura da tabela `aux_grau_formacao`
--

DROP TABLE IF EXISTS `aux_grau_formacao`;
CREATE TABLE IF NOT EXISTS `aux_grau_formacao` (
  `id` int(11) NOT NULL,
  `dsc_nome` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Extraindo dados da tabela `aux_grau_formacao`
--

INSERT INTO `aux_grau_formacao` (`id`, `dsc_nome`) VALUES
(1, 'Graduação'),
(2, 'Pós-Graduação'),
(3, 'Mestrado');
...
DROP TABLE IF EXISTS `aux_sexo`;
CREATE TABLE IF NOT EXISTS `aux_sexo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dsc_sexo` varchar(15) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `aux_sexo` (`id`, `dsc_sexo`) VALUES
(1, 'Feminino'),
(2, 'Masculino'),
(3, 'Não declarado');
...
--
-- Estrutura da tabela `aux_status`
--
...
--
-- Extraindo dados da tabela `aux_status`
--

INSERT INTO `aux_status` (`id`, `dsc_nome`) VALUES
(1, 'Pendente'),
(2, 'Confirmado'),
(3, 'Em Atendimento'),
(4, 'Faltou'),
...
--
-- Estrutura da tabela `aux_tipo_evolucao`
--

DROP TABLE IF EXISTS `aux_tipo_evolucao`;
CREATE TABLE IF NOT EXISTS `aux_tipo_evolucao` (
  `id` int(11) NOT NULL,
  `dsc_nome` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `aux_tipo_evolucao`
--

INSERT INTO `aux_tipo_evolucao` (`id`, `dsc_nome`) VALUES
(1, 'Regrediu'),
(2, 'Não Evoluiu'),
(3, 'Evoluiu');
...
--
-- Estrutura da tabela `aux_tipo_sanguineo`
--

DROP TABLE IF EXISTS `aux_tipo_sanguineo`;
CREATE TABLE IF NOT EXISTS `aux_tipo_sanguineo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dsc_tipo_sanguineo` varchar(3) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `aux_tipo_sanguineo`
--

INSERT INTO `aux_tipo_sanguineo` (`id`, `dsc_tipo_sanguineo`) VALUES
(1, 'A+'),
(2, 'A-'),
(3, 'B+'),
(4, 'B-'),
...
CREATE TABLE IF NOT EXISTS `tb_agenda` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fk_agenda_disponibilidade` int(11) NOT NULL,
  `fk_paciente` int(11) NOT NULL,
  `fk_fonoaudiologo` int(11) NOT NULL,
  `fk_status` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tb_agenda_fonoaudiologo1_idx` (`fk_fonoaudiologo`),
  KEY `fk_tb_agenda_aux_status1_idx` (`fk_status`),
  KEY `fk_tb_paciente_idx` (`fk_paciente`),
  KEY `fk_tb_agenda_disponibilidade_idx` (`fk_agenda_disponibilidade`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_agenda` (`id`, `fk_agenda_disponibilidade`, `fk_paciente`, `fk_fonoaudiologo`, `fk_status`) VALUES
(1, 1, 1, 2, 5),
(2, 2, 1, 2, 3),
(3, 3, 1, 2, 3);
...
--
-- Estrutura da tabela `tb_agenda_disponibilidade`
--

DROP TABLE IF EXISTS `tb_agenda_disponibilidade`;
CREATE TABLE IF NOT EXISTS `tb_agenda_disponibilidade` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fk_fonoaudiologo` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_tb_agenda_disponibilidade_fonoaudiologo1_idx` (`fk_fonoaudiologo`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_agenda_disponibilidade`
--

INSERT INTO `tb_agenda_disponibilidade` (`id`, `fk_fonoaudiologo`, `dat_atendimento`, `hor_inicio`, `hor_fim`) VALUES
(1, 2, '2019-01-09', '08:00:00', '09:00:00'),
(2, 2, '2019-01-09', '09:00:00', '10:00:00'),
(3, 2, '2019-01-09', '10:00:00', '11:00:00'),
(4, 2, '2019-01-09', '11:00:00', '12:00:00');
...
CREATE TABLE IF NOT EXISTS `tb_consulta` (
  ...
  `fk_fonoaudiologo` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tb_consulta_paciente1_idx` (`fk_paciente`),
  KEY `fk_tb_consulta_fonoaudiologo1_idx` (`fk_fonoaudiologo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tb_evolucao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dsc_evolucao` text NOT NULL,
  `fk_flag_evolucao` int(11) NOT NULL,
  `fk_fonoaudiologo` int(11) NOT NULL,
  `fk_paciente` int(11) NOT NULL,
  `dsc_titulo` varchar(45) NOT NULL,
  `dat_evolucao` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_tb_evolucao_aux_tipo_evolucao1_idx` (`fk_flag_evolucao`),
  KEY `fk_tb_evolucao_fonoaudiologo_idx` (`fk_fonoaudiologo`),
  KEY `fk_tb_evolucao_paciente_idx` (`fk_paciente`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_evolucao`
--

INSERT INTO `tb_evolucao` (`id`, `dsc_evolucao`, `fk_flag_evolucao`, `fk_fonoaudiologo`, `fk_paciente`, `dsc_titulo`, `dat_evolucao`) VALUES
(3, 'teste', 1, 2, 1, 'teste', '2018-10-23 15:40:36'),
(4, 'teste', 1, 2, 1, 'teste', '2018-10-23 15:40:40'),
(11, 'teste teste', 2, 2, 1, 'teste', '2018-10-25 15:50:40'),
(16, 'tcubk', 1, 2, 1, 'testes', '2018-10-25 17:34:46'),
(19, 'wefgb', 2, 2, 1, 'teste', '2018-12-18 11:12:30'),
(20, 'wefgb', 2, 2, 1, 'teste', '2018-12-18 11:12:31'),
(21, 'wefgb', 2, 2, 1, 'teste', '2018-12-18 11:12:32'),
(22, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:52'),
(23, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:53'),
(24, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:53'),
(25, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:53'),
(26, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:53'),
(27, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:53'),
(28, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:54'),
(29, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:54'),
(30, 'ffqefef', 2, 2, 1, 'dwfwq', '2018-12-18 11:12:54'),
(31, 'dhfgjhg', 2, 2, 1, 'kuhk', '2018-12-18 11:14:50'),
(32, 'tretet', 1, 2, 1, 'trertet', '2018-12-18 11:24:07'),
(33, 'tretet', 1, 2, 1, 'trertet', '2018-12-18 11:24:10'),
(34, 'efefewf', 2, 2, 1, 'dwfewf', '2018-12-18 11:26:13'),
(35, 'efefewf', 2, 2, 1, 'dwfewf', '2018-12-18 11:26:15'),
(36, 'dfdsgsg', 1, 2, 3, 'teste', '2018-12-18 11:29:31'),
(37, 'dfdsgsg', 1, 2, 3, 'teste', '2018-12-18 11:29:35');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_fonoaudiologo`
--

DROP TABLE IF EXISTS `tb_fonoaudiologo`;
CREATE TABLE IF NOT EXISTS `tb_fonoaudiologo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `frg_pessoa` int(11) NOT NULL,
  `num_crf` int(11) NOT NULL,
  `frg_grau_formacao` int(11) NOT NULL,
  `arr_areas` varchar(50) DEFAULT NULL,
  `arr_cursos` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_fonoaudiologo_tb_pessoa1_idx` (`frg_pessoa`),
  KEY `fk_fonoaudiologo_aux_grau_formacao1_idx` (`frg_grau_formacao`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_fonoaudiologo`
--

INSERT INTO `tb_fonoaudiologo` (`id`, `frg_pessoa`, `num_crf`, `frg_grau_formacao`, `arr_areas`, `arr_cursos`) VALUES
(1, 2, 32323, 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_fonoaudiologo_paciente`
--

DROP TABLE IF EXISTS `tb_fonoaudiologo_paciente`;
CREATE TABLE IF NOT EXISTS `tb_fonoaudiologo_paciente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `frg_fonoaudiologo` int(11) NOT NULL,
  `frg_paciente` int(11) NOT NULL,
  `flag_situacao` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_fonoaudiolgo_paciente_fonoaudiologo_idx` (`frg_fonoaudiologo`),
  KEY `fk_fonoaudiologo_paciente_paciente_idx` (`frg_paciente`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_fonoaudiologo_paciente`
--

INSERT INTO `tb_fonoaudiologo_paciente` (`id`, `frg_fonoaudiologo`, `frg_paciente`, `flag_situacao`) VALUES
(1, 2, 1, 1);
...
CREATE TABLE IF NOT EXISTS `tb_formacao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dsc_instituicao` varchar(45) NOT NULL,
  `ano_conclusao` int(4) NOT NULL,
  `dsc_nome` varchar(45) NOT NULL,
  `fk_grau_formacao` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tb_formacao_aux_grau_formacao1_idx` (`fk_grau_formacao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tb_jogo` (
  ...
  `dsc_fonema` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tb_laudo`;
CREATE TABLE IF NOT EXISTS `tb_laudo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `frg_fonoaudiologo` int(11) NOT NULL,
  `frg_paciente` int(11) NOT NULL,
  `dsc_historia_clinica` varchar(300) NOT NULL,
  `dsc_exame_clinico` varchar(300) NOT NULL,
  `dsc_condutas` varchar(300) NOT NULL,
  `dsc_hipoteses_diagnosticas` varchar(45) NOT NULL,
  `dat_laudo` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_laudo_fonoaudiologo_idx` (`frg_fonoaudiologo`),
  KEY `fk_laudo_paciente_idx` (`frg_paciente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tb_paciente` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_paciente_tb_pessoa1_idx` (`id_pessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_paciente` (`id`, `id_pessoa`) VALUES
('1', 1),
('2', 3);
...
--
-- Estrutura da tabela `tb_paciente_deficiencia`
--

DROP TABLE IF EXISTS `tb_paciente_deficiencia`;
CREATE TABLE IF NOT EXISTS `tb_paciente_deficiencia` (
  `fk_deficiencia` int(11) NOT NULL,
  `fk_paciente` int(11) NOT NULL,
  `dsc_descricao` text,
  `fk_fonoaudiologo` int(11) NOT NULL,
  PRIMARY KEY (`fk_deficiencia`,`fk_paciente`,`fk_fonoaudiologo`),
  KEY `fk_tb_paciente_deficiencia_tb_paciente1_idx` (`fk_paciente`),
  KEY `fk_tb_paciente_deficiencia_fonoaudiologo1_idx` (`fk_fonoaudiologo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_paciente_fonema`
--

DROP TABLE IF EXISTS `tb_paciente_fonema`;
CREATE TABLE IF NOT EXISTS `tb_paciente_fonema` (
  `fk_paciente` int(11) NOT NULL,
  `fk_fonema` int(11) NOT NULL,
  `fk_fonoaudiologo` int(11) NOT NULL,
  PRIMARY KEY (`fk_paciente`),
  KEY `fk_tb_paciente_fonema_aux_fonema1_idx` (`fk_fonema`),
  KEY `fk_tb_paciente_fonema_fonoaudiologo1_idx` (`fk_fonoaudiologo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tb_pessoa` (
  `id` int(11) NOT NULL,
  `dsc_cpf` varchar(11) NOT NULL,
  `dsc_nome` varchar(80) NOT NULL,
  `img_perfil` varchar(200) DEFAULT NULL,
  `dsc_email` varchar(45) NOT NULL,
  `dat_nascimento` date DEFAULT NULL,
  `dsc_telefone1` varchar(12) NOT NULL,
  `dsc_telefone2` varchar(12) DEFAULT NULL,
  `frg_cor` int(11) NOT NULL,
  `frg_endestado` int(11) NOT NULL,
  `frg_endcidade` int(11) NOT NULL,
  `dsc_endbairro` varchar(45) NOT NULL,
  `dsc_endcep` varchar(45) NOT NULL,
  `dsc_endnum` varchar(15) NOT NULL,
  `dsc_endrua` varchar(50) NOT NULL,
  `dsc_nomemae` varchar(80) DEFAULT NULL,
  `dsc_nomepai` varchar(80) DEFAULT NULL,
  `frg_estado_civil` int(11) NOT NULL,
  `frg_sexo` int(11) NOT NULL,
  `frg_nasestado` int(11) DEFAULT NULL,
  `frg_nascidade` int(11) DEFAULT NULL,
  `frg_tipo_sanguineo` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `dsc_cpf_UNIQUE` (`dsc_cpf`),
  UNIQUE KEY `dsc_email_UNIQUE` (`dsc_email`),
  KEY `tb_pessoa_cor_idx` (`frg_cor`),
  KEY `tb_pessoa_sexo_idx` (`frg_sexo`),
  KEY `tb_pessoa_endcidade_idx` (`frg_endcidade`),
  KEY `fk_pessoa_endestado` (`frg_endestado`),
  KEY `fk_pessoa_nasestado_idx` (`frg_nasestado`),
  KEY `fk_pessoa_nascidade_idx` (`frg_nascidade`),
  KEY `fk_pessoa_tipo_sanguineo_idx` (`frg_tipo_sanguineo`),
  KEY `fk_pessoa_estado_civil_idx` (`frg_estado_civil`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_pessoa` (`id`, `dsc_cpf`, `dsc_nome`, `img_perfil`, `dsc_email`, `dat_nascimento`, `dsc_telefone1`, `dsc_telefone2`, `frg_cor`, `frg_endestado`, `frg_endcidade`, `dsc_endbairro`, `dsc_endcep`, `dsc_endnum`, `dsc_endrua`, `dsc_nomemae`, `dsc_nomepai`, `frg_estado_civil`, `frg_sexo`, `frg_nasestado`, `frg_nascidade`, `frg_tipo_sanguineo`) VALUES
(1, '09049013430', 'Paciente', NULL, 'paciente@gmail.com', NULL, '82999999999', NULL, 1, 2, 147, 'Pontal da Barra', '57010000', '21', 'Rua12', 'Mãe teste Paciente', 'Pai teste Paciente', 1, 1, 2, 147, 1),
(2, '09049013433', 'Fono', NULL, 'fono@gmail.com', NULL, '082999999955', NULL, 1, 2, 147, 'Farol', '57010000', 'S/N', 'Avenida Fernandes Lima', 'Mãe teste Fono', 'Pai teste Fono', 1, 1, 2, 147, 1),
(3, '09049046465', 'Paciente 2', NULL, 'paciente2@gmail.com', NULL, '082999999999', NULL, 1, 2, 147, 'Ponta Verde', '57010360', '255', 'Rua teste', 'Mãe Paciente Teste', 'Pai Paciente Teste', 1, 1, 2, 147, 1);
...
ALTER TABLE `tb_agenda`
  ADD CONSTRAINT `fk_tb_agenda_aux_status1` FOREIGN KEY (`fk_status`) REFERENCES `aux_status` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_agenda_disponibilidade` FOREIGN KEY (`fk_agenda_disponibilidade`) REFERENCES `tb_agenda_disponibilidade` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_agenda_fonoaudiologo1` FOREIGN KEY (`fk_fonoaudiologo`) REFERENCES `tb_fonoaudiologo` (`frg_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_paciente` FOREIGN KEY (`fk_paciente`) REFERENCES `tb_paciente` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_agenda_disponibilidade`
--
ALTER TABLE `tb_agenda_disponibilidade`
  ADD CONSTRAINT `fk_tb_agenda_disponibilidade_fonoaudiologo1` FOREIGN KEY (`fk_fonoaudiologo`) REFERENCES `tb_fonoaudiologo` (`frg_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_consulta`
--
ALTER TABLE `tb_consulta`
  ADD CONSTRAINT `fk_tb_consulta_fonoaudiologo1` FOREIGN KEY (`fk_fonoaudiologo`) REFERENCES `tb_fonoaudiologo` (`frg_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_consulta_paciente1` FOREIGN KEY (`fk_paciente`) REFERENCES `tb_paciente` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_evolucao`
--
ALTER TABLE `tb_evolucao`
  ADD CONSTRAINT `fk_tb_evolucao_aux_tipo_evolucao1` FOREIGN KEY (`fk_flag_evolucao`) REFERENCES `aux_tipo_evolucao` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_evolucao_fonoaudiologo` FOREIGN KEY (`fk_fonoaudiologo`) REFERENCES `tb_fonoaudiologo` (`frg_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_evolucao_paciente` FOREIGN KEY (`fk_paciente`) REFERENCES `tb_paciente` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_fonoaudiologo`
--
ALTER TABLE `tb_fonoaudiologo`
  ADD CONSTRAINT `fk_fonoaudiologo_aux_grau_formacao1` FOREIGN KEY (`frg_grau_formacao`) REFERENCES `aux_grau_formacao` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_fonoaudiologo_tb_pessoa1` FOREIGN KEY (`frg_pessoa`) REFERENCES `tb_pessoa` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_formacao`
--
ALTER TABLE `tb_formacao`
  ADD CONSTRAINT `fk_tb_formacao_aux_grau_formacao1` FOREIGN KEY (`fk_grau_formacao`) REFERENCES `aux_grau_formacao` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_laudo`
--
ALTER TABLE `tb_laudo`
  ADD CONSTRAINT `frg_laudo_fonoaudiologo` FOREIGN KEY (`frg_fonoaudiologo`) REFERENCES `tb_fonoaudiologo` (`frg_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `frg_laudo_paciente` FOREIGN KEY (`frg_paciente`) REFERENCES `tb_paciente` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_paciente_deficiencia`
--
ALTER TABLE `tb_paciente_deficiencia`
  ADD CONSTRAINT `fk_tb_paciente_deficiencia_aux_deficiencia1` FOREIGN KEY (`fk_deficiencia`) REFERENCES `aux_deficiencia` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_paciente_deficiencia_fonoaudiologo1` FOREIGN KEY (`fk_fonoaudiologo`) REFERENCES `tb_fonoaudiologo` (`frg_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_paciente_deficiencia_tb_paciente1` FOREIGN KEY (`fk_paciente`) REFERENCES `tb_paciente` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_paciente_fonema`
--
ALTER TABLE `tb_paciente_fonema`
  ADD CONSTRAINT `fk_tb_paciente_fonema_aux_fonema1` FOREIGN KEY (`fk_fonema`) REFERENCES `aux_fonema` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_paciente_fonema_fonoaudiologo1` FOREIGN KEY (`fk_fonoaudiologo`) REFERENCES `tb_fonoaudiologo` (`frg_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tb_paciente_fonema_tb_paciente1` FOREIGN KEY (`fk_paciente`) REFERENCES `tb_paciente` (`id_pessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tb_pessoa`
--
ALTER TABLE `tb_pessoa`
  ADD CONSTRAINT `fk_pessoa_cor` FOREIGN KEY (`frg_cor`) REFERENCES `aux_cor` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoa_endcidade` FOREIGN KEY (`frg_endcidade`) REFERENCES `aux_cidade` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoa_endestado` FOREIGN KEY (`frg_endestado`) REFERENCES `aux_estado` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoa_estado_civil` FOREIGN KEY (`frg_estado_civil`) REFERENCES `aux_estado_civil` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoa_nascidade` FOREIGN KEY (`frg_nascidade`) REFERENCES `aux_cidade` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoa_nasestado` FOREIGN KEY (`frg_nasestado`) REFERENCES `aux_estado` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoa_sexo` FOREIGN KEY (`frg_sexo`) REFERENCES `aux_sexo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoa_tipo_sanguineo` FOREIGN KEY (`frg_tipo_sanguineo`) REFERENCES `aux_tipo_sanguineo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
