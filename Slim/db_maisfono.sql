...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 26-Out-2018 às 19:38
...
CREATE TABLE IF NOT EXISTS `tb_agenda_disponibilidade` (
  ...
  `hor_incio_manha` time NOT NULL,
  `hor_fim_manha` time NOT NULL,
  `hor_incio_tarde` time NOT NULL,
  `hor_fim_tarde` time NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tb_agenda_disponibilidade_fonoaudiologo1_idx` (`fk_fonoaudiologo`),
  KEY `fk_tb_agenda_disponibilidade_aux_dia_semana1_idx` (`fk_dia_semana`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `tb_agenda_disponibilidade`
  ADD CONSTRAINT `fk_tb_agenda_disponibilidade_aux_dia_semana1` FOREIGN KEY (`fk_dia_semana`) REFERENCES `aux_dia_semana` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
